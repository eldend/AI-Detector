          ...
          <div className="bg-slate-800/50 backdrop-blur-xl rounded-lg border border-slate-700/50 overflow-hidden">
            ...
            <div className="p-6">
              <div className="text-green-400 font-mono text-sm mb-4">
                $ policy-manager --load --security-rules
              </div>
              <div className="flex items-center gap-3 mb-4">
                <div className="w-4 h-4 border-2 border-yellow-400/50 border-t-yellow-400 rounded-full animate-spin"></div>
